...
import OpportunityForm from '@/components/admin/OpportunityManagement/OpportunityForm';
      ...
      <div className="bg-white border-b -mx-6 -mt-6 mb-6 px-6 py-4 md:-mx-10 md:-mt-10 md:mb-6 md:px-10">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Add a new opportunity to the system</p>
          </div>
        </div>
      </div>
