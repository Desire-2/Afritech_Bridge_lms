      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            <button
              onClick={() => router.back()}
              className="flex items-center px-3 py-2 sm:px-4 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors text-sm sm:text-base w-fit"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
              <span className="hidden sm:inline">Back to Grading Center</span>
              <span className="sm:hidden">Back</span>
            </button>
            <div className="sm:border-l sm:border-slate-200 sm:dark:border-slate-700 sm:pl-4">
              <h1 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-white flex items-center">
                <Award className="w-5 h-5 sm:w-7 sm:h-7 mr-2 sm:mr-3 text-blue-600" />
                Assignment Grading
              </h1>
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mt-0.5 sm:mt-1">Review and grade student submission</p>
            </div>
          </div>
          
          <div className="flex items-center">
            {submission?.days_late === 0 ? (
              <div className="flex items-center bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-400 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg text-sm">
              ...
              <div className="flex items-center bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-400 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-3 sm:px-6 sm:py-4">
              <div className="flex items-start sm:items-center gap-2 flex-wrap">
                <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-white flex-shrink-0 mt-0.5 sm:mt-0" />
              ...
              <p className="text-blue-100 mt-1 text-sm sm:text-base">{submission.course_title}</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 px-4 py-3 sm:px-6 sm:py-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-base sm:text-xl font-bold text-white">Student Submission</h3>
                </div>
                <div className="flex items-center">
                  {submission.days_late === 0 ? (
          ...
          <form onSubmit={handleSubmitGrade} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-4 py-3 sm:px-6 sm:py-4">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2 pb-4 border-b border-slate-200 dark:border-slate-700">
                  <button
                    ...
                    className="flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-900/30 transition-colors text-xs sm:text-sm font-medium"
                  >
                    <FileBarChart className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                    {showRubricPanel ? 'Hide' : 'Use'} Rubric
                  </button>
                  <button
                    type="button"
                    onClick={() => setShowCommentBank(!showCommentBank)}
                    className="flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/30 transition-colors text-xs sm:text-sm font-medium"
                  >
                    <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                    <span className="hidden xs:inline">{showCommentBank ? 'Hide' : 'Show'} </span>Comments
                  </button>
                  <button
                    type="button"
                    onClick={autoSaveDraft}
                    disabled={autoSaving}
                    className="flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 rounded-lg hover:bg-green-200 dark:hover:bg-green-900/30 transition-colors text-xs sm:text-sm font-medium disabled:opacity-50"
                  >
                ...
                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                  <button
                    type="submit"
                    disabled={grading || !grade}
                    className="flex-1 flex items-center justify-center px-4 py-2.5 sm:py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-semibold text-sm sm:text-base"
                  >
                    {grading ? (
                      <>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center px-4 py-2.5 sm:py-3 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors font-medium text-sm sm:text-base"
                  >
                    Request Changes
                  </button>
                </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          {submission.student_info && (
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="bg-gradient-to-r from-indigo-500 to-blue-600 px-4 py-3 sm:px-6 sm:py-4">
                <div className="flex items-center space-x-2">
          ...
          {submission.grade !== undefined && submission.grade !== null && submission.assignment_points && (
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="bg-gradient-to-r from-yellow-500 to-orange-500 px-4 py-3 sm:px-6 sm:py-4">
                <div className="flex items-center space-x-2">
                  <Star className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  <h3 className="text-base sm:text-lg font-bold text-white">Current Grade</h3>
                </div>
              </div>
          ...
          {submission.previous_attempts && submission.previous_attempts.length > 0 && (
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="bg-gradient-to-r from-gray-600 to-slate-700 px-4 py-3 sm:px-6 sm:py-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <History className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                    <h3 className="text-base sm:text-lg font-bold text-white">Previous Attempts</h3>
                  </div>
