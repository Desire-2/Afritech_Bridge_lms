    ...
    try:
        ...
        for enrollment in pagination.items:
            ...
            records.append({
                ...
                'payment_slip_url': (enrollment.payment_slip_url if enrollment.payment_slip_url and not enrollment.payment_slip_url.startswith('data:') else None),
                'payment_slip_filename': enrollment.payment_slip_filename,
                'has_payment_slip': bool(enrollment.payment_slip_url),
